        ...
        <>
            <section className={styles[props.processclass]}>
                <Container>
                    <Row>
                        <Col>
                            <h3 className='white font30 f-500 center'>Streamlined Process to Develop Your App</h3>
                            <h2 className='white f-60 f-700 center'>Explore Our App Development Journey</h2>
                            <p className='white font16 f-400 center'>We believe in efficiency without compromising quality. Our streamlined process for app development is designed to be transparent and collaborative, ensuring your vision comes to life exactly as you imagined.</p>
