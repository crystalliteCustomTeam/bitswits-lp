...
//images
const banImg = await import("../public/images/hire-page/native.png");
  ...
  return (
    <>
        ...
        textArray={[
          {
            title: (
              <>
                Want to Hire <br /> <span>Native App Developers</span>?
              </>
            ),
            text: [
              <>
      ...
      <HireSteps
        textArray={[
          {
            title: <>How to Hire Native Programmer</>,
            text: [
              <>
        ...
        textArray={[
          {
            title: (
              <>
                ...
                <span> Native App Developer</span>
              </>
            ),
          },
        ]}
        tabsData={[
          {
            ...
            content: {
              imageSrc: benif1,
              heading:
                "Hire Native App Programmer to Gear-Up Your App with Influential Technologies and Methodologies",
              text: [
                ...
                "In the past 10 years, we have excelled our skills and worked on more than 1000+ Native app development projects. Offering the best quality is our motto. Delivering innovative and awestruck apps is our Native programmer’s aim.",

                "Hire Native app developer  to take the best service to your workplace.",
              ],
            },
          },
          {
          ...
          },
          {
            ...
            content: {
              imageSrc: benif4,
              heading:
                "Hire Native E-Commerce App Programmer to Gear-Up Your App with Influential Technologies and Methodologies",
              text: [
                "Hiring our extravagant Native app developer will bring an extra edge to your business by designing exceptionally remarkable apps. Once you choose our services, all your burden is ours and we assure you the best iPad and Native app solutions suitable to your business.",
        ...
        textArray={[
          {
            title: (
              <>
                Why should you Hire <br /> <span> Native App Developer</span>
                Online?
              </>
            ),
          },
