          ...
          <Row className="  align-items-center">
            ...
            <Col lg={4}>
              <div>
                {/* <Slider
                  {...bannerslider}
                  className={` ${styles.startSlide} Serbannerslider`}
                >
                  <div className={styles.strpImg}>
                    ...
                    <p className="white font12 mt-4 mb-1">
                      ...
                      user-friendly platform with advanced analytics and robust
                      data integration. Their attention to detail in every phase
                      ensured ProEYE's success in the blockchain arena.
                    </p>
                  ...
                  <div className={styles.strpImg}>
                    ...
                    <p className="white font12 mt-4 mb-1">
                      ...
                      perfectly aligning it with our SEO firm's workflow. Their
                      team delivered an efficient, user-friendly solution with
                      impressive attention to detail. We highly recommend
                      Bitswits for their professionalism and app development
                      expertise.
                    </p>
                    <div className="d-flex align-items-center gap-2 my-1">
                  ...
                  <div className={styles.strpImg}>
                    ...
                    <p className="white font12 mt-4 mb-1">
                      ...
                      significantly improved processing speed, productivity, and
                      accuracy. Their proactive engagement, soliciting of
                  ...
                  <div className={styles.strpImg}>
                    ...
                    <p className="white font12 mt-4 mb-1">
                      ...
                      our project's needs. Their team's expertise and efficiency
                      were impressive, delivering high-quality work within our
                      budget. The app they developed is exactly what we
                      envisioned, both innovative and user-friendly.
                    </p>
                    <div className="d-flex align-items-center gap-2 my-1">
                      <h4 className="white font20 mb-1">Jordan</h4>
                    </div>
                    <div className="d-flex align-items-center justify-content-between mt-3 mb-3">
                      <p className="white font12 mb-0">Tech Startup Founder</p>
                      <div className="d-flex align-items-center gap-2">
                        <Image
                          src={verified}
                          width={15}
                  ...
                  <div className={styles.strpImg}>
                    ...
                    <p className="white font12 mt-4 mb-1">
                      ...
                      chain. They developed an AI-assisted inventory management
                      system that automates stock level tracking and predictive
                      ordering. The accuracy and efficiency it brings to our
                      supply chain management are phenomenal. It's a prime
                      example of how AI can transform traditional retail
                      operations.
                    </p>
                    <div className="d-flex align-items-center gap-2 my-1">
                    ...
                    <div className="d-flex align-items-center justify-content-between mt-3 mb-3">
                      <p className="white font12 mb-0">Retail Chain Manager</p>
                      <div className="d-flex align-items-center gap-2">
                        <Image
                          src={verified}
                          width={15}
