...
<section className={styles.counter}>
    <Container fluid>
        <Row className={styles.android}>
            <h3>Who We've</h3>
            <h2>Developed Android Apps For</h2>
            <p>We work with the best of the best to create the best of the best. We feel passionately about the projects <br /> we choose to take on and that means you get an invested team that will do everything in their power to <br /> turn your idea into a full-fledged app.</p>
        </Row>
        <Row>
