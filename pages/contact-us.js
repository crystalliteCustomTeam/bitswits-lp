                        ...
                        <div className={styles.contactCard}>
                            <Row className="justify-content-center align-content-center py-5">
                                <Col lg={10} className='mx-auto'>
                                    <h2 className="font40 font-bold t-center"> Say Hello!</h2>
                                    <p className="t-center font18 font-medium">
                                ...
                                <Row className="p-md-4 p-3 mt-4">
                                    <Col lg={8} className="mt-3">
                                        <h2 className="font40 font-bold f-s mb-2">
                                            For Work <span className="grdiant">Inquiry</span>
                                        </h2>
                                        <p className="font14 font-medium">
                                        ...
                                        <form id="contactusform1" >
                                            <Row>
                                                ...
                                                <Col lg={12} className='mt-3'>
                                                    ...
                                                    <input type="file" name="upload" id="upload" className="form-control-file" />
                                                </Col>
                                                <Col lg={12}>
                                    ...
                                    <Col lg={4}>
                                        <div className="pt-4 pe-md-3 px-md-3">
                                            ...
                                            <h2 className="font20 font-bold mb-1">
                                                For Work Inquiry
                                            </h2>
                                            ...
                                            <h4 className="font20 font-bold mb-0">For Career Inquiry</h4>
                                            <ul className="ps-0 my-3">
                                                <li>
                                                    <Link href="mailto:hr@bitswits.co" className="grdiant font-bold">Email Us</Link>
                                                </li>
                                            </ul>
                                            <h4 className="font20 font-bold mb-4">Connect With Us</h4>
                                            <div className={styles.socialicons}>
                                                <Link href="#">
                                                    <FaFacebookF size={20} classNameName={styles.email} />
                                                </Link>
                                                <Link href="#">
                                                    <AiOutlineInstagram size={20} classNameName={styles.email} />
                                                </Link>
                                                <Link href="#">
                                                    <AiOutlineTwitter size={20} classNameName={styles.email} />
                                                </Link>
                                                <Link href="#">
                                                    <FaLinkedinIn size={20} classNameName={styles.email} />
                                                </Link>
                                                <Link href="#">
                                                    <BsYoutube size={20} classNameName={styles.email} />
                                                </Link>
                                            </div>
                                        </div>
                                    </Col>
