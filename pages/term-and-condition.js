          ...
          <Row>
            ...
            <Col lg={12}>
              ...
              <p className="font14 font-500 fontf white">
                BitWits ensures that every project we undertake is managed with
                expertise and committed to delivering exactly what was promised
                in the proposal. We have established clear service guidelines
                and Conditions of Use for each of our offerings, which will be
                referenced when evaluating refund requests following the
                completion of our dispute-resolution process.
              </p>
              <p className="font14 font-500 fontf white">
                While we strive to ensure every project meets our clients’
                expectations, we acknowledge that exceptional circumstances can
                arise. In such cases, we may consider issuing refunds. To
                determine if you are eligible for a refund, please reach out to
                us at Contact Email.
              </p>
              <h3 className="font30 font-bold fontf white mt-4">
                Terms & Conditions
              </h3>
              <p className="font14 font-500 fontf white">
              ...
              <p className="font14 font-500 fontf white">
                ...
                for non-commercial purposes by you or within your organization
                only. In consideration of this consent, you agree that copies of
                the Web site information will retain all copyright and other
                proprietary notices and that you will not modify the Web site
                information in any way. Except where your use constitutes “fair
              ...
              <p className="font14 font-500 fontf white">
                ...
                the Web site or the Web site information for any purpose that is
                unlawful or prohibited by these Terms of Use. You will not use
                this Web site in any manner that could damage, disable, overload
                or impair the operation of this Web site or use by third
                parties.
              </p>
              <p className="font14 font-500 fontf white">
              ...
              <p className="font14 font-500 fontf white">
                ...
                service or product currently in development or currently
                anticipated to be made available in the future.
              </p>
              <p className="font14 font-500 fontf white">
              ...
              <p className="font14 font-500 fontf white">
                ...
                other product or service and warranties as to such product or
                service purchased by you using, or in connection with, this Web
                site, if any, is governed by the terms of the agreement
