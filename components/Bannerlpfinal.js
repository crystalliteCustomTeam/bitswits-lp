                    ...
                    <Row className={`${styles.alignpost} gx-5`}>
                        <Col xl={7}>
                            ...
                            <div className={styles.comple}>
                                ...
                                <Image alt='BitsWits' src={clutch} className='img-fluid' />
                            </div>
                        ...
                        <Col xl={5}>
                            <form className={styles.your}>
                                ...
                                <div className={styles.ouroff}>
                                    <span>
                                        <Image alt='BitsWits' src={usa} className='img-fluid' />
                                        <p>USA</p>
                                    </span>
                                    <span>
                                        <Image alt='BitsWits' src={dubai} className='img-fluid' />
                                        <p>MIDDLE EAST</p>
                                    </span>
                                    <span>
                                        <Image alt='BitsWits' src={asia} className='img-fluid' />
                                        <p>ASIA</p>
                                    </span>
                                </div>
