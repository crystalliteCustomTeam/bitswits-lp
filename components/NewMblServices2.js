...
import styles from "@/styles/NewMblMaintain2.module.css";
                ...
                <Container>
                    <Row className='g-3'>
                        <Col lg={12}>
                            ...
                            <h3 className={styles.develop}>Maintaining digital quality with
                                our collection <br></br> of customizable services</h3>
                        </Col>
                        <Col md={6} lg={4}>
