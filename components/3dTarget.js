...
import styles from "@/styles/3dTarget.module.css";
                ...
                <Container>
                    ...
                    <Row className={styles.after}>
                        <Col xl={12}>
                            ...
                            <h2>Invigorate Your Target Audience<br></br> With Dynamic Gameplay</h2>
                            <p>It's time to develop compelling storylines and rich characters with BitsWits; after all, don't you want to create an immersive experience? We use the<br></br> latest technologies and cutting-edge visuals to enable players to interact intuitively, whether playing on a PC, console, or mobile device.</p>
                    ...
                    <Row className='gy-0 gx-0'>
                        <Col xl={6}>
                            <div className={styles.desigh}>
                                ...
                                <p>BitsWits bring your visions into gaming reality following a structured and mindful approach.
                                    Our ideation process starts by exploring potential themes and genres to create an ideal design concept. We then move on to planning out the game's structure and detailing the game design document. Once the plan is locked in, we move on to building the game prototype. Our team works in tandem to create the basic visuals and gameplay for the game with all features intact. The end result is nothing short of amazing - a game that best aligns with the interests and goals of the client and functions seamlessly!</p>
                                <Link href="#">Get to know us  <Image quality={75} src={home_btn1} className='img-fluid' /> </Link>
                            </div>
                        </Col>
                        <Col xl={6}>
