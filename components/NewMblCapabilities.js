                                ...
                                <Row className='align-items-center'>
                                    <Col xl={6}>
                                        <div className={styles.deter}>
                                            ...
                                            <p className={styles.cen}>  <Image quality={75} src={close} className='img-fluid' />Telemedicine Solution</p>
                                            <p className={styles.cen}>  <Image quality={75} src={close} className='img-fluid' />Electronic Health Records (EHR)</p>
                                            <p className={styles.cen}>  <Image quality={75} src={close} className='img-fluid' />Practice Management Systems</p>
                                            <p className={styles.cen}>  <Image quality={75} src={close} className='img-fluid' />Clinical Software Solutions</p>
                                            <p className={styles.cen}>  <Image quality={75} src={close} className='img-fluid' />Medical Device Integrations Solutions</p>
                                        </div>
                                    </Col>
                                    <Col xl={6}>
