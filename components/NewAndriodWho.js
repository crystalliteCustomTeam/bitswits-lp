...
//
import WhoImage from "@/public/images/iosbanner/who_image.png"
                    ...
                    <Row>
                        ...
                        <Col lg={10}>
                            <div className={`${styles.secImagebg} text-center pt-4`}>
                                <Image quality={75} alt='Bitswits' height="550" src={WhoImage} className={`${styles.secImage} img-fluid`} />
                            </div>
                        </Col>
                    </Row>
