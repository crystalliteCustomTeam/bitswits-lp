...
export default function fooddelivery() {
  ...
  const newtextpont = <span> The client asked BitsWits to design a user-friendly and intuitive mobile <br></br> application that allows customers to place orders swimmingly. They further <br></br> requested to incorporate a secure payment method and real-time tracking <br></br> feature to keep tabs on all orders.<br></br> <br></br>  And since free items are always customers' favorite, our client asked for this <br></br> unique feature to be added to the app.</span>
  ...
  const media1 = <p className='font16 fontf font-medium  mt-1 mb-0 white'>By introducing the review and rating feature on the app, customers can now conveniently assess different restaurants based on the items listed. This way, they will reap all the benefits from simply providing valuable feedback.</p>
  ...
  const data = <p className='font16 white fontf font-medium line30'>
    By offering customers unparalleled convenience today, the food delivery application of Find Food is functioning exceptionally well. BitsWits made it easy for the app owner to connect customers to their favorite food chains easily. Additionally, customers appreciated the convenience of ordering food <span className='white font-bold font18'>Read More</span>
  </p>
  ...
  const headingbanner = <h1 className='white fontf font-bold'>Crave <br />Courier </h1>
