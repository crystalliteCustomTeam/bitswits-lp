                    ...
                    <Row className='g-3'>
                        ...
                        <Col lg={12}>
                            <div className={styles.app3}>
                                <Row className='align-items-center'>
                                    <Col xl={6}>
                                        <h3 className='text-white f-22 font-bold '>EOS Dapp Game Development</h3>
                        ...
                        <Col xl={6}>
                            <div className={styles.app9}>
                                <div className={styles.cardContent}>
                                    <h3 className='text-white f-22 font-bold text-center'>In-Game Asset & Token Creation</h3>
                        ...
                        <Col xl={6}>
                            <div className={styles.app10}>
                                <div className={styles.cardContent}>
                                    <h3 className='text-white f-22 font-bold text-center'>Smart Contract Dapp Game Development</h3>
