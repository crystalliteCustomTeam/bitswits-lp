...
export default function hirePrestashopDeveloper() {
    ...
    const infopara = <> <p className='black fontf font-medium line30 mt-5'>We’ve delivered more than <strong>100+</strong> PrestaShop Websites to <strong>70+</strong> clients in the last. <strong>21 years</strong> (Scroll down to see examples of our work)</p> </>
