    ...
    return (
        <>
            ...
            <Container className='mt-5 mb-5'>
                <Row>
                    <h3 className='font30 font-bold fontf'>Refund Policy:</h3>
                    <p className='font16 font-500 fontf mb-0'>BitWits ensures that every project we undertake is managed with expertise and committed to delivering exactly what was promised in the proposal. We have established clear service guidelines and Conditions of Use for each of our offerings, which will be referenced when evaluating refund requests following the completion of our dispute-resolution process.</p>
                    <p className='font16 font-500 fontf'>While we strive to ensure every project meets our clients’ expectations, we acknowledge that exceptional circumstances can arise. In such cases, we may consider issuing refunds. To determine if you are eligible for a refund, please reach out to us at Contact Email.</p>

                    <h3 className='font30 font-bold fontf'>Terms & Conditions</h3>
                    ATTENTION: PLEASE READ THIS STATEMENT CAREFULLY BEFORE USING BitsWits (THIS “WEBSITE”). YOUR USE OF THIS WEBSITE CONSTITUTES YOUR ACCEPTANCE OF THIS COPYRIGHT STATEMENT AND TERMS OF USE (COLLECTIVELY, “TERMS OF USE”). IF YOU DO NOT ACCEPT THESE TERMS OF USE, DO NOT USE THIS WEBSITE. <br></br> <br></br>

                    BitsWits reserves the right to modify these Terms of Use without notice and any modifications are effective when they are posted here. BitsWits may, at any time, in its discretion terminate your access to this Web site. Access to the Web site may be monitored by BitsWits If you are accessing this Web site as a representative of an organization, these Terms of Use bind both you inpidually and the organization and references to “you” and “your” shall be construed to apply to you inpidually and the organization. <br></br> <br></br>

                    While BitsWits maintains copyright protection in all materials, information and publications (collectively, “Web site information”) it places on this Web site, BitWits consents to normal downloading, copying and distribution of the information for non-commercial purposes by you or within your organization only. In consideration of this consent, you agree that copies of the Web site information will retain all copyright and other proprietary notices and that you will not modify the Web site information in any way. Except where your use constitutes “fair use” under copyright law, you may not otherwise use, download, upload, copy, print, display, perform, reproduce, publish, or distribute any Website information, in whole or in part, without the prior written consent of BitsWits. <br></br> <br></br>
