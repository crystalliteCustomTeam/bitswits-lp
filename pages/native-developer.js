...
//images
import banImg from '../public/images/hire-page/native.png'
//
    ...
    return (
        <>
            ...
            <HireWant
                textArray={[
                    {
                        title: <>Want to Hire <br /> <span>Native App Developers</span>?</>,
                        text: [
            ...
            <HireBenifits
                textArray={[
                    {
                        title: <>Benefits to Hire Remote <br /> <span> Native App Developer</span> </>,
                    }
                ]}
                tabsData={
                    [
                        {
                            ...
                            content: {
                                imageSrc: benif1,
                                heading: 'Hire Native App Programmer to Gear-Up Your App with Influential Technologies and Methodologies',
                                text: [
                                    ...
                                    'We are liable to your queries and will provide you with the most decent Native app development services yet classy for the users. Hire Native developer India team to keep you buoyant whole app development cycle.',
                        ...
                        },
                        {
                            ...
                            content: {
                                imageSrc: benif4,
                                heading: 'Hire Native E-Commerce App Programmer to Gear-Up Your App with Influential Technologies and Methodologies',
                                text: [
                                    'Hiring our extravagant Native app developer will bring an extra edge to your business by designing exceptionally remarkable apps. Once you choose our services, all your burden is ours and we assure you the best iPad and Native app solutions suitable to your business.',
            ...
            <HireChoose
                textArray={[
                    {
                        title: <>Why should you Hire <br /> <span> Native App Developer</span> Online? </>,
                    }
                ]}
                choosesArray={
                    [
