  ...
  return (
    <>
      ...
      <CaseWants
        sections1={[
          {
            title: <> Soulful Features: Building <br /> Bonds and <span>Memories</span> </>,
            textArray: [
              'Personal Journaling',
              'In-App Purchases',
              'Inviting Pals',
        ...
        wantImg3={tackling}
        lastPara={<> With a proactive approach, Soul Scribe is dedicated to providing a smooth and enjoyable user experience, making sure that our software continues to be the preferred choice for social networking and personal journaling, allowing users to create, connect, and celebrate their most beloved recollections. </>}
      />
