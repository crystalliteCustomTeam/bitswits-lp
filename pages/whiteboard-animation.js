...
export default function whiteboardanimation() {
    ...
    const heading = <h1 className='font65 black fontf font-bold line60'>The Best Design and <br /><span className='grdiant'>WHITEBOARD ANIMATION</span> Company!</h1>
    ...
    const whytitle = <h2 className='font40 black fontf font-bold line60 black text-center mb-3'>Look At The Services We Have In <span className='grdiant'>WHITEBOARD ANIMATION</span> For You</h2>
    ...
    const expsubtile = <h2 className='font50 black fontf font-bold line60 black'>Our <span className='grdiant'>WHITEBOARD ANIMATION</span> Solutions</h2>
    ...
    const whyEptTitle = <h2 className='font40 black fontf font-bold line60 black text-center mb-3'>Why <span className='grdiant'>WHITEBOARD ANIMATION</span></h2>
