...
const LeftContent = (props) => {
    return (
        <>
            <div className={`${styles[props.whychooseclass]} secPad bg-black`}>
                <Container >
        ...
        <source src='/images/blockchain.mp4' type="video/mp4"/>       
                                    ...
                                    <video className={`${styles.bgVideo} img-fluid`} width={500} autoPlay muted loop src="../../../artificialIntelligence/Images/starlycoin.mp4" type="video/mp4"></video>
