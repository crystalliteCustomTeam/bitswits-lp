...
//components
import Banner from '@/components/SponsordBanner'
...
//images
import foldImg from '../public/images/case-sponsord/beats.png'
import foldImg00 from '../public/images/case-sponsord/horizons.png'
import ReadyCTA from '@/components/ReadyCTA';
import SponsordHarmony from '@/components/SponsordHarmory';
import SponsordCTA from '@/components/SponsordCTA';
...
export default function Sponsord() {
    ...
    const code1 = <div> <span className={styles.left}>#16FFBD</span> </div>
    const code2 = <div> <span className={styles.right}>#FD03E5</span>  </div>
    const code3 = <div> <span className={styles.mid}>#050424</span>  </div>
    const heading12 = <h3 className='fontf font60 white center font-bold'>Color Harmony</h3>


    const headingbanner = <h1 className='white font100 font-bold mb-5'>Sponsor'd </h1>
    const para2 = <p className='white services f-20'>Germ-Guard is a cutting-edge cleaning company with headquarters in the USA. Their network in the USA includes more than 500 plus workforce of cleaning companies. Not only this, but they provide on-demand <br></br> neighborhood cleaning services as well. </p>
