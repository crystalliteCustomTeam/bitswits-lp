...
const SmartTech = React.lazy(() => import("@/components/new-blockchain-page-fy/SmartTech"));
  ...
  return (
    <>
      ...
      <Provideservices
        ...
        title={<h3 className="font_30 fontsfheavy newfycolr">Blockchain Development Services</h3>}
        bigtitle={<h2 className="newchoose letterspace_1 font-bold white">Our Web Development Company <br />
          Can Build Your Dream Website</h2>}
        para={<p className="font_17 white fontsfregular pt-2 pb-2">Our website development services at Chetu can create your dream website. We design engaging and user-friendly websites that <br /> improve the customer experience, we work with you to understand your business goals and preferences. From simple blogs to <br /> complex e-commerce platforms, we are dedicated to delivering high-quality solutions that exceed your expectations. Let us bring <br /> your vision to life and enhance your online presence.</p>}
        sec={[
          {
            img1: bestgloba11,
            titl3: 'Custom Website Application Development',
            para4: 'Our team has experience developing a wide range of web applications, from simple web apps to complex enterprise solutions. We use the latest development tools and frameworks to design fast, reliable, and secure web applications that meet your business needs. We can customize your existing applications for Enterprise Resource Planning (ERP), E-Commerce, Interactive Gaming, Online Training & Courses, Customer Relationship Management (CRM), and so much more.'
          },
          {
            img1: bestgloba12,
            titl3: 'Content Management Systems',
            para4: 'We can help you integrate CMS capabilities into your existing website or application or develop a custom content management system (CMS) that makes it easy to manage your website content. Our CMS solutions are user-friendly, reliable, and flexible, allowing you to add and edit web content without needing to rewrite or update any code.'
          },
          {
            img1: bestgloba13,
            titl3: 'No Cookie-Cutter Solutions',
            para4: 'Our expert website development teams build, utilize, integrate, and customize the right tools, technologies, and frameworks to accomplish the goals that you’ve set forth. Whether you require Data Integration Services, Enterprise Application Integrations, Data Migrations & Upgrades, Implementation & Deployment, API Development & Integration, Quality Assurance, or more, we’ve got you covered.'
          },
          {
            img1: bestgloba14,
            titl3: 'Diverse Coding Experience',
            para4: 'From database design and web app development to system integrations and cloud consulting, our diverse team of Full-Stack Developers has the expertise to build your next software application. Our software engineers have many years of combined experience working with Java, JavaScript, PHP, Python, Objective-C, Ruby on Rails, jQuery, AngularJS, Node.js.NET Framework, and so much more.'
          },
          {
            img1: bestgloba15,
            titl3: 'Maintenance, Monitoring, & Support',
            para4: 'Our expert web design and development team provides ongoing maintenance, monitoring, and support to ensure that your custom websites and apps are working at optimal performances. Our Web Development Support and Maintenance Services include testing and debugging, updates and maintenance on security protocols, database maintenance, and so much more.'
          },
        ]}
      ...
      <SmartContract
        assignClass='providecustom'
        title={<h3 className="font_30 fontsfheavy newfycolr center">Web Design and Development Company</h3>}
        bigtitle={<h2 className="newchoose letterspace_1 font-bold white center">Professional Web Design and <br />
          Development Company</h2>}
        para={<p className="linehight_2 font_17 white fontsfregular font-regular pt-1  center">Our Full-Stack Web Developers have the programming expertise and industry-specific experience to build, integrate, and customize <br /> your website or application to align perfectly with your vision.</p>}
        sec={[
          {
            img1: msbestgloba11,
            title3: 'Web App Integration Services',
            para4: 'We always stay on top of the latest developments in deployment, customization, and integration to design the perfect, seamless approach to how you utilize your software. Our back-end developers are experts in Java, PHP, Ruby, Python, SQL, and more while our front-end designers are well-versed in using JavaScript, CSS3, HTML5, and more.'
          },
          {
            img1: msbestgloba12,
            title3: 'Mobile App Development Services',
            para4: 'With years of expertise under our belt, our team specializing in custom mobile app development can assist you in creating seamless and fluid experiences across various mobile devices.'
          },
          {
            img1: msbestgloba13,
            title3: 'Enterprise Web Design and Development ',
            para4: 'We use custom APIs and our vast knowledge of web services to build Enterprise Web Applications for digital marketing, CRM, inventory control, expedited workflows, and so much more.'
          },
          {
            img1: msbestgloba14,
          ...
          },
          {
            ...
            para4: 'We leverage AI techniques like federated learning, which can be applied to protect the privacy of data stored on the blockchain. AI algorithms enable computations on encrypted data, allowing privacy-preserving analysis while maintaining data confidentiality.'
          },
          {
            img1: msbestgloba16,
      ...
      <Provideservices
        ...
        title={<h3 className="font_30 fontsfheavy newfycolr">Web Development Services</h3>}
        bigtitle={<h2 className="newchoose letterspace_1 font-bold white">AI Web Development Services</h2>}
        para={<p className="font_17 white fontsfregular pt-2 pb-2 maxwidthweb">By leveraging artificial intelligence and machine learning, our AI web development services enable the  creation of smarter, more personalized websites. Chetu offers a variety of efficient and cost-effective AI-   powered web development services tailored to businesses' unique needs. From chatbots and virtual  assistants to predictive analytics and content optimization, our AI software developers helps businesses  stay ahead of the curve and deliver exceptional user experiences. </p>}
        sec={[
          {
            img1: chatbots1,
            titl3: 'Chatbots And Virtual Assistants',
            para4: 'Our experts customize AI-powered programs to provide automated customer support and assistance to website visitors. We build custom chatbots using programming languages like Python, Java, or JavaScript. Our website engineers use artificial intelligence and natural language processing technologies to build custom virtual assistants that improve the customer experience. '
          },
          {
            img1: chatbots2,
      ...
      <SmartTech
        assignClass='providecustom'
        title={<h3 className="font_30 fontsfheavy newfycolr center">Technology </h3>}
        bigtitle={<h2 className="newchoose letterspace_1 font-bold white center">Full-Stack Technology </h2>}
        para={<p className="linehight_2 font_17 white fontsfregular font-regular pt-1  center">Our Website Developers utilize multiple software platforms, providing greater computing power, enhanced graphics, robust security <br/> standards, and improved performance levels.</p>}
        sec1title='Client Software (Front-End)'
        sec={[
          {
            img1: js1,
            title3: 'Java Script',
            para4: 'Our software engineers use JavaScript to calculate, manipulate, and validate different data to create dynamic and interactive user experiences.'
          },
          {
            img1: js2,
            title3: 'Html',
            para4: 'Our Software Development Team has many years of collective experience working with HTML programming language for developing best-in-class custom websites and applications.'
          },
          {
            img1: js3,
            title3: 'Json',
            para4: 'We use JSON for transmitting web application data in a much quicker and more efficient fashion to optimize the process of building your web application.'
          },
          {
            img1: js4,
            title3: 'Elm',
          ...
          },
          {
            img1: js5,
            title3: 'Angular Js',
            para4: 'We use AngularJS when creating dynamic web applications, appropriating its data binding, and dependency injection to eliminate the need to write an extensive amount of code.'
          },
          {
            img1: js6,
            title3: 'J Query',
        ...
        sec2={[
          {
            img1: php1,
            title3: 'Php',
            para4: 'Our Software Development Team uses PHP frameworks to provide a basic structure for streamlining and speeding up the development process of building personalized web websites and apps.'
          },
          {
            img1: php2,
            title3: 'Express.Js',
            para4: 'Our experts utilize Express.js to simplify the web application development process, making it easier to write fast, secure, and modular applications.'
          },
          {
            img1: php3,
            title3: 'Node.Js',
            para4: 'We use Node.js to create traditional websites, back-end API services, and data-intensive real-time applications that run across distributed devices.'
          },
          {
            img1: php4,
            title3: 'Java',
          ...
          },
          {
            img1: php5,
            title3: 'Python',
            para4: 'We use Python as one of our primary programming languages for mobile and custom web development, video games, operating systems, machine learning, AI, and more'
          },
          {
            img1: php6,
            title3: 'Mongo Db',
