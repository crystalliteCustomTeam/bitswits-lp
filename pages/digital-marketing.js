...
export default function digitalmarketing() {
    ...
    const heading = <h1 className='font65 black fontf font-bold line60'>The Best Design and <br /><span className='grdiant'> DIGITAL MARKETING </span> Company!</h1>
...
<Container>
                <Row>
                    <Col xl={12}>
                        <h3 className='center font-bold'>Creating Milestones With The Work We Do!</h3>
                        <h4 className='center mt-3 mb-5'>We’re constantly engaged in doing great things and that’s what makes us the best.</h4>
                    </Col>
                </Row>
                <Row className='gy-5'>
                    <Col xl={4}>
