...
//Why Icon
import icon24 from '../public/images/fix/1.png'
import icon25 from '../public/images/fix/2.png'
import icon26 from '../public/images/fix/3.png'
import icon27 from '../public/images/fix/4.png'
...
export default function hiremongodbdeveloper() {


    // banner component data

    const heading = <h1 className='font65 black fontf font-bold line60'>Hire our in-house expert <br /><span className='grdiant'>
        MongoDB Developers </span> from
        $20/hr today</h1>
...
const infopara = <> <p className='black fontf font-medium line30 mt-3'>Did you know? We've delivered 41+ MongoDB
solutions since MongoDB launched in 2009.</p> </>
    ...
    const whytitle = <h2 className='font30 black fontf font-bold line60 black text-center mb-1'>Development Features</h2>
    ...
    return (
        <>
            ...
            <WhyBuild
                title="Why Build"
                cards={WhyBuilds}
                text={<> <p className='center'>Fast, Flexible and Scalable – but there are still more features to explore!</p> </>}
                subtitle={whytitle}
            />
