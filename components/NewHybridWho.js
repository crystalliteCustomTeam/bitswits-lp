                    ...
                    <Row>
                        <Col lg={12}>
                            <div className={styles.text_content}>
                                ...
                                <p className={`${styles.wid} text-white f-500`}>
                        ...
                        <Col lg={10}>
                            <div className={`${styles.secImagebg} text-center pt-4`}>
                                <Image quality={75} alt='BitsWits' src={WhoImage}  height="550" className={`${styles.secImage} img-fluid`} />
                            </div>
                        </Col>
                    </Row>
