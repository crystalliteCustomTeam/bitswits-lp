...
export default function mobileappdevelopmentusa() {
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Don't let platform limitations hold you back. Our mobile apps development US company uses the technologies and frameworks to create apps that work seamlessly." />
            ...
            <NewBannerFy
                ...
                subtitle='Transform Mobile User Experience With'
                title={<>Leading <span className='grdiant'>Application <br></br> Development
                    Company</span> in USA </>}
            ...
            <Creativeopportunities
                ...
                tit2='Android Apps'
                text2={<> Our android app developers use the best and latest technologies that leave a lasting impression and bring satisfaction to our clients. </>}
                btn2='Lets Start'

                tit3='React Native'
                text3={<>  Our developers use leverage react native to create cross-platform mobile apps that provide a native user experience on various devices. </>}
                btn3='Lets Start'

                tit4='IoT Apps'
                text4={<>  We bring the idea of IoT apps to life by creating flawless apps with the help of our latest tools and frameworks. </>}
                btn4='Lets Start'

                tit5='Game Apps'
                text5={<>  We don’t just create game apps – our goal is to make gaming experiences so immersive and engaging that players never want to leave. </>}
                btn5='Lets Start'
