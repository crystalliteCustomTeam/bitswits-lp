...
//images
const banImg = await import("../public/images/hire-page/android.png");
  ...
  return (
    <>
        ...
        textArray={[
          {
            title: (
              <>
                Want to Hire <br /> <span>Android App Developers</span>?
              </>
            ),
            text: [
              <>
      ...
      <HireSteps
        textArray={[
          {
            title: <>How to Hire Android Programmer</>,
            text: [
              <>
        ...
        tabsData={[
          {
            ...
            content: {
              imageSrc: benif1,
              heading:
                "Hire Android App Programmer to Gear-Up Your App with Influential Technologies and Methodologies",
              text: [
                ...
                "In the past 10 years, we have excelled our skills and worked on more than 1000+ Android app development projects. Offering the best quality is our motto. Delivering innovative and awestruck apps is our Android programmer’s aim.",

                "Hire Android app developer  to take the best service to your workplace.",
              ],
            },
          },
          {
          ...
          },
          {
            ...
            content: {
              imageSrc: benif4,
              heading:
                "Hire Android E-Commerce App Programmer to Gear-Up Your App with Influential Technologies and Methodologies",
              text: [
                "Hiring our extravagant Android app developer will bring an extra edge to your business by designing exceptionally remarkable apps. Once you choose our services, all your burden is ours and we assure you the best iPad and Android app solutions suitable to your business.",
