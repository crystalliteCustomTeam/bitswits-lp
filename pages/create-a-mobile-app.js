  ...
  return (
    <>
      <Head>
        ...
        {/* Title & Description */}
        <title>Create a Mobile App | Custom Solutions from Concept to Launch</title>
        <meta name="description" content="Create a Mobile App with Bitswits. Where Innovation Meets Excellence | Bitswits.co" />
        {/* OG Tags */}
