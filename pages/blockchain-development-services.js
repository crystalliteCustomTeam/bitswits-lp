  ...
  return (
    <>
      ...
      <Provideservices
        ...
        bigtitle={<h2 className="newchoose letterspace_1 font-bold white">We Provide Blockchain Development Services</h2>}
        para={<p className="font_17 white fontsfregular pt-2 pb-2">Our software developers are highly proficient in building blockchain technologies from scratch and customizing existing <br /> blockchain solutions through software integrations, functionality modifications, and feature implementations.</p>}
        title2={<h3 className="font_30 font-bold newfycolr">Blockchain Technology Development</h3>}
        para2={<p className="font_15 linehight_1 white fontsfregular pt-2">Bitswits is a leading development company that can help you hit the market with a newly developed Blockchain solution or revamp your existing systems. Our Blockchain Development promotes business growth while transforming companies and establishing improved business models with custom cryptocurrencies, consensus algorithms, individual nodes, and architectures.</p>}
        sec={[
          {
            img1: bestgloba11,
            titl3: 'Blockchain Security',
            para4: 'We create blockchain security software that identifies and addresses the fundamental elements of a cross-industry standard for shared and distributed ledgers while transforming how businesses conduct transactions globally.'
          },
          {
            img1: bestgloba12,
            titl3: 'Public & Private Blockchain',
            para4: 'We develop customized and protected private blockchain for businesses that process hundreds or thousands of transactions per second, as well as open, decentralized public blockchain that grants public access to the network.'
          },
          {
            img1: bestgloba13,
            titl3: 'Decentralized Applications (Dapps)',
            para4: 'We develop custom decentralized applications and integrate them into existing enterprise systems where businesses can leverage a protected, secure environment for collaboration and diverse business transactions.'
          },
        ]}
        video = {<video autoPlay loop muted src='././cry.mp4' className="w-100 h-100" ></video>}
      />

      <SmartContract
        assignClass='provideserv'
        title={<h3 className="font_30 fontsfheavy newfycolr center">Blockchain Development Services</h3>}
        bigtitle={<h2 className="newchoose letterspace_1 font-bold white center">Custom AI Blockchain Development Services</h2>}
        para={<p className="linehight_2 font_17 white fontsfregular font-regular pt-1  center">Our developers can combine Artificial Intelligence (AI) and Blockchain to more effectively secure data, establish ownership, optimize <br /> smart contracts, and track goods. We integrate AI technology into Blockchain software to develop transformative solutions across <br /> various industries. Our AI Blockchain solutions provide advanced functionality and optimal benefits.</p>}
        sec = {[
          {
            img1: mbestgloba11,
            title3 : 'Data Analysis',
            para4 : 'Our experts can develop Blockchain software with AI algorithms that analyze large volumes of data recorded on the Blockchain to gather insights, patterns, and trends. AI can identify anomalies and predict future behavior using machine learning and data analytics strategies.'
          },
          {
            img1: mbestgloba12,
            title3 : 'Natural Language Processing',
            para4 : 'Our AI and Blockchain experts can incorporate natural language processing capabilities into your AI-powered Blockchain solution to enhance smart contracts to have the ability to understand human-readable language and enable greater accessibility of Blockchain technology. This streamlines business processes and reduces the need for manual intervention.'
          },
          {
            img1: mbestgloba13,
            title3 : 'Smart Contract Optimization',
            para4 : 'Our Blockchain development using AI includes smart contract optimization, which automates the process of contract creation, validation, and enforcement. AI analyzes contract templates, historical data, and legal regulations to generate more efficient and smart contracts. It improves contract performance, reduces errors, and enhances contract management processes.'
          },
          {
            img1: mbestgloba14,
