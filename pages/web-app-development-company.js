...
import icon29 from '../public/images/fyicons/88.png'
import icon30 from '../public/images/fyicons/89.png'
import icon31 from '../public/images/fyicons/90.png'
    ...
    const para = <>
        ...
        <ul className='mb-4 mt-2 p-0'>
            ...
            <li className="font15 fontf font-medium fyColor ">
                <Image quality={75} src={mobilearrow} alt="bitswits" className='img-fluid multi'></Image>250+ successfully completed projects </li>
            <li className="font15 fontf font-medium fyColor ">
                <Image quality={75} src={mobilearrow} alt="bitswits" className='img-fluid multi'></Image>Robust Security Measures </li>
            <li className="font15 fontf font-medium fyColor ">
                <Image quality={75} src={mobilearrow} alt="bitswits" className='img-fluid multi'></Image>24/7 Dedicated Support </li>
            <li className="font15 fontf font-medium fyColor ">
                <Image quality={75} src={mobilearrow} alt="bitswits" className='img-fluid multi'></Image>100% customized web app solutions </li>
