  ...
  return (
    <>
      ...
      <Bannerlp6
        subtitle={
          <> 
            <h3 className="font30 font-bold text-center">
              Create an App, Make a Mark
            </h3> 
          </>
        }
        title={
          <>
            <h2
              className={`${styles.develop} text-center font50 font-bold mb-3`}
            >
        ...
        para={
          <>
            <p className="font20 white center mb-3">
              Beautiful, High-Performance Apps Delivered 
              <span className={styles.txtDec}>ON TIME</span> and 
              <span className={styles.txtDec}>WITHIN BUDGET</span>
            </p>
          </>
        }
